...
{
    public partial class ReservableInventory<T>
    {
        ...
        public class Builder
        {
            ...
            public ReservableInventory<T> Build()
            {
                ...
                return new ReservableInventory<T>(_maxCapacity, _maxSlots, _itemSizes, _maxSlotSize, _itemCapacities, _items);
            }
        }
    }
}
